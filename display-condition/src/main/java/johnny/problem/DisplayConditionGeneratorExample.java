...
public class DisplayConditionGeneratorExample {
    public static void main(String[] args) {
        ...
        // [[a0], [a1]]
        System.out.println(DisplayConditionGenerator.getDimensionCombinations(List.of("a")));

        System.out.println("Create 4 dimensions with 2 conditions");
        // [[a0, b0], [a0, b1], [a1, b0], [a1, b1]]
        System.out.println(DisplayConditionGenerator.getDimensionCombinations(List.of("a", "b")));
        ...
        System.out.println(DisplayConditionGenerator.getDimensionCombinations(List.of("a", "b", "c")));
        ...
        System.out.println(DisplayConditionGenerator.getDimensionCombinations(List.of("a", "b", "c", "d")));
    }
}
