...
public class DisplayConditionGeneratorExample {
    public static void main(String[] args) {
        ...
        // [[a0], [a1]]
        System.out.println(DisplayConditionGenerator.combine(new String[]{"a"}));

        System.out.println("Create 4 dimensions with 2 conditions");
        // [[a0, b0], [a0, b1], [a1, b0], [a1, b1]]
        System.out.println(DisplayConditionGenerator.combine(new String[]{"a", "b"}));
        ...
        System.out.println(DisplayConditionGenerator.combine(new String[]{"a", "b", "c"}));
        ...
        System.out.println(DisplayConditionGenerator.combine(new String[]{"a", "b", "c", "d"}));
    }
}
